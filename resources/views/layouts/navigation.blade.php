<nav x-data="{ open: false }" class="bg-gray-50 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex items-center">
                ...
                <div class="hidden space-x-6 sm:ml-10 sm:flex">
                    ...
                    {{-- <x-nav-link :href="route('top_stories')" :active="request()->routeIs('top_stories')">
                        {{ __('Top Stories') }}
                    </x-nav-link> --}}
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            {{-- <x-responsive-nav-link :href="route('top_stories')" :active="request()->routeIs('top_stories')">
                {{ __('Top Stories') }}
            </x-responsive-nav-link> --}}
            <x-responsive-nav-link :href="route('opinions')" :active="request()->routeIs('opinions')">
                {{ __('Opinions') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('sports.get')" :active="request()->routeIs('sports.get')">
                {{ __('Sports News') }}
            </x-responsive-nav-link>
        </div>
