...
<div class="max-w-9xl mx-auto px-4 sm:px-6 lg:px-8 mt-16   ">
    ...
    <span class="text-center text-primary font-bold   underline  lg:mx-8">      
    ...
    <p class="mt-4 text-lg font-bold ml-0   whitespace-pre-line tracking-wider space-x-4 bg-zinc-50 p-4">
...
<div class="  mx-auto px-4 sm:px-6 lg:px-8 mt-16">
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-4">
      ...
      <div class="p-4 bg-white shadow-md rounded-lg">
          <a href="{{ route('businesses.show', $related->slug) }}" class="block">
