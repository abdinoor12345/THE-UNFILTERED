...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-16">
    <main class="container mx-auto bg-transparent mt-8">
        <h1 class="text-lg text-blue-800 text-center font-mono font-extrabold">Add permissions </h1>
        <form action="{{ route('permissions.update', $permissions->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <input type="text" id="name" name="name" value="{{ $permissions->name }}" class="block w-full p-4 text-gray-900 border border-blue-300 rounded-lg bg-gray-50 text-base focus:ring-blue-500 focus:border-blue-800 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
