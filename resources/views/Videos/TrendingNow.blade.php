...
<div class="mx-auto px-4 sm:px-6 lg:px-8 mt-16 bg-slate-900 border-l-8 border-sky-500">
    <h1 class="text-center text-red-700 text-2xl font-mono animate-pulse"> 🔥 Trending Now

    </h1>
    <p class="text-xl font-sans text-white  animate-pulse "> Stay up-to-date with what’s buzzing. This section covers
         the most talked-about news, viral stories, and social media trends.</p>
