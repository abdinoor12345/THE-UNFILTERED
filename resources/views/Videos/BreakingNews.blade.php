...
<div class="mx-auto px-4 sm:px-6 lg:px-8 mt-16 bg-slate-900 border-l-8 border-sky-500">
    <h1 class="text-center text-red-700 text-2xl font-mono">📰 Breaking News</h1>
    <p class="text-xl font-sans text-white animate-pulse">Get the latest and most urgent updates from around the world. Stay informed
         with real-time breaking news on events that are shaping the headlines.</p>
